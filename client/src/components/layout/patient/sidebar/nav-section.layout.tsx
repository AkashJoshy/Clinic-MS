...
import PatientRenderNavItem from "./render-nav-item.layout";
...
const PatientNavSection: React.FC<Props> = ({ title, items, collapsed, setCollapsed }) => {
  return (
...
export default PatientNavSection;
