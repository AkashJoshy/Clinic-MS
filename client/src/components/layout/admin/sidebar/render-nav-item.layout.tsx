...
import LogoutAlert from "../../logout-alert.layout";
import type { RouteRoleProps, Tokens } from "@/types/auth";
import { logoutUser } from "@/services/auth.service";
import { useAuthMutate } from "@/hooks/use-auth-mutate.hook";
...
const RenderNavItem: React.FC<Props> = ({ item, collapsed, role }) => {
