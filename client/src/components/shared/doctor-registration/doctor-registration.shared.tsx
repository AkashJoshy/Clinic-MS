import BasicInfo from "./basic-info.shared";
import { useMutate } from "@/hooks/use-mutate.hook";
import { useNavigate } from "react-router-dom";
import RegistrationHeader from "./header.shared";
import { useDoctorRegistrationContext } from "@/contexts/use-doctor-registration.context";
import ProfessionalInfo from "./professional-info.shared";
import AccountSecurity from "./account-security.shared";
import ClinicInfo from "./clinic-info.shared";
import ClinicAddress from "./clinic-address.shared";
import ConsultationInfo from "./consultation-info.shared";
import VerificationDocs from "./verification-docs.shared";
