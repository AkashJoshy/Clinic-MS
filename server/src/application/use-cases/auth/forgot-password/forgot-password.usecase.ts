...
import { EMAIL_BODY, EMAIL_SUBJECTS } from "../../../../domain/constants/email.constants.js";
...
export class ForgotPasswordUseCase implements IForgotPasswordUseCase {
  ...
  async execute(data: ForgotRolePasswordDto): Promise<void> {
    ...
    const resetLink = `${process.env.CLIENT_ORIGIN}/change-password?token=${resetToken}`;
    ...
    await this._mailService.sendMail(email, EMAIL_SUBJECTS.RESET_PASSWORD, emailBody);
  }
}