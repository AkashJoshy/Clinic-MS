...
import { MongooseDoctorClinicRepository } from "../../repositories/mongoose-doctor-clinic.repository.js";
...
const slotExtendUseCase = new SlotExtendWindowUseCase(doctorClinicRepository, slotRepository, slotGenerationService);

const slotGeneratorJob: ScheduledTask = cron.schedule(
    "0 8 * * *",
    async () => {
        try {
