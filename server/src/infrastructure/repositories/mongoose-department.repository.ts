...
import { DepartmentModel, type IDepartment } from "../models/department.model.ts";
import { MongooseBaseRepository } from "./base/mongoose-base.repository.ts";

export class MongooseDepartmentRepository extends MongooseBaseRepository<Department, IDepartment> implements IDepartmentRepository {
